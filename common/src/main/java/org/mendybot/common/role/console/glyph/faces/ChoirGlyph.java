package org.mendybot.common.role.console.glyph.faces;
...
import org.mendybot.common.application.model.widget.faces.FacesListener;
import org.mendybot.common.application.model.widget.faces.FacesWidget;
import org.mendybot.common.role.console.ConsoleRole;
import org.mendybot.common.role.console.glyph.Glyph;

public class ChoirGlyph extends Glyph implements FacesListener
{
  ...
  public ChoirGlyph(ConsoleRole console, String name, String widgetName)
  {
    super(console, name, widgetName);
    FacesWidget widget = (FacesWidget) console.getModel().lookupWidget(widgetName);
    widget.addFacesListener(this);
