...
public class ToTheColor2
{
  ...
  static {
    ...
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.DOTTED_EIGHTH));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.SIXTEENTH));

    int measureCount = 1;
    m = s.lookup(measureCount++, VOICE);
    m.add(new Note(Midi.D5, Dynamic.MF, NoteType.QUARTER));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.DOTTED_EIGHTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.QUARTER));
    m.add(new Note(Midi.D4, Dynamic.MF, NoteType.DOTTED_EIGHTH));
    m.add(new Note(Midi.D4, Dynamic.MF, NoteType.SIXTEENTH));
    m = s.lookup(measureCount++, VOICE);
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.QUARTER));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.DOTTED_EIGHTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.QUARTER));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.DOTTED_EIGHTH));
    ...
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.SIXTEENTH));
    m = s.lookup(measureCount++, VOICE);
    m.add(new Note(Midi.D5, Dynamic.MF, NoteType.HALF));
    ...
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.EIGHTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.EIGHTH));
    ...
    m.add(new Note(Midi.D4, Dynamic.MF, NoteType.SIXTEENTH));
    m = s.lookup(measureCount++, VOICE);
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.HALF));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.EIGHTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.EIGHTH));
    m.add(new Note(Midi.G4, Dynamic.MF, NoteType.EIGHTH));
    m = s.lookup(measureCount++, VOICE);
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.HALF));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.EIGHTH));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.SIXTEENTH));
    m.add(new Note(Midi.B4, Dynamic.MF, NoteType.EIGHTH));
